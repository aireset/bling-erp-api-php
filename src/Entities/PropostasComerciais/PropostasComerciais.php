...
namespace Aireset\BlingErpApi\Entities\PropostasComerciais;

use Aireset\BlingErpApi\Entities\PropostasComerciais\Schema\Delete\DeleteResponse;
use Aireset\BlingErpApi\Entities\PropostasComerciais\Schema\DeleteMany\DeleteManyResponse;
use Aireset\BlingErpApi\Entities\PropostasComerciais\Schema\ChangeSituation\ChangeSituationResponse;
use Aireset\BlingErpApi\Entities\PropostasComerciais\Schema\ChangeSituationMany\ChangeSituationManyResponse;
use Aireset\BlingErpApi\Entities\PropostasComerciais\Schema\Get\GetParams;
